        ...
        <section id="projects" className={`${Styles.mainContainer}`}>
            ...
            <div className={Styles.infoContainer}>
                ...
                <div className={`row g-0 justify-content-center align-items-center mb-3`}>
                    ...
                    <div className={`col-lg-3 col-10`}>
                        <ProjectCard projectName={'Personal portafolio'} ProjectImage={'./portafolio-project.png'} Stack={`React/Next.js/Bootstrap`} description={`Personal portafolio using Next.js`} />
                    </div>
                    <div className={`col-lg-3 col-10`}>
